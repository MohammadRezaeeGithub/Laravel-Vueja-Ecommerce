...
<template>
    ...
    <div class="flex justify-between border-b-2 pb-3">
      ...
      <table class="table-auto w-full">
        <thead>
        <tr>
            <TableHeaderCell @click="sortUser" class="border-b-2 p-2 text-left" field="id" :sort-field="sortField" :sort-direction="sortDirection">ID</TableHeaderCell>
            ...
            <TableHeaderCell @click="sortUser" class="border-b-2 p-2 text-left" field="email" :sort-field="sortField" :sort-direction="sortDirection">Email</TableHeaderCell>
            <TableHeaderCell @click="sortUser" class="border-b-2 p-2 text-left" field="created_at" :sort-field="sortField" :sort-direction="sortDirection">Create Date</TableHeaderCell>
